...
from domain.goods import MotorProductRepository, SberSuperMarketProvider, ProductInfoService
...
async def get_product_parser_service() -> ProductInfoService:
    ...
    return ProductInfoService(
        ...
        product_provider=SberSuperMarketProvider(parser=parser_client, base_url=parser_config.url)
    )
